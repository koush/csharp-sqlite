namespace Community.Data.SQLite
{
  public partial class csSQLite
  {
    ...
    const int OP_Program = 25;
    const int OP_Return = 26;
    const int OP_Remainder = 88   /* same as TK_REM      */;
    const int OP_NewRowid = 27;
    const int OP_Multiply = 86   /* same as TK_STAR     */;
    const int OP_Variable = 28;
    const int OP_String = 29;
    const int OP_RealAffinity = 30;
    const int OP_VRename = 31;
    const int OP_ParseSchema = 32;
    const int OP_VOpen = 33;
    const int OP_Close = 34;
    const int OP_CreateIndex = 35;
    const int OP_IsUnique = 36;
    const int OP_NotFound = 37;
    const int OP_Int64 = 38;
    const int OP_MustBeInt = 39;
    const int OP_Halt = 40;
    const int OP_Rowid = 41;
    const int OP_IdxLT = 42;
    const int OP_AddImm = 43;
    ...
    const int OP_Yield = 59;
    const int OP_DropTrigger = 60;
    const int OP_DropIndex = 61;
    const int OP_Param = 62;
    ...
    const int OP_Transaction = 101;
    const int OP_VFilter = 102;
    const int OP_Ne = 73   /* same as TK_NE       */;
    const int OP_VDestroy = 103;
    const int OP_BitOr = 81   /* same as TK_BITOR    */;
    const int OP_Next = 104;
    const int OP_Count = 105;
    const int OP_IdxInsert = 106;
    const int OP_Lt = 77   /* same as TK_LT       */;
    const int OP_SeekGe = 107;
    const int OP_Insert = 108;
    const int OP_Destroy = 109;
    const int OP_ReadCookie = 110;
    const int OP_RowSetTest = 111;
    const int OP_LoadAnalysis = 112;
    const int OP_Explain = 113;
    const int OP_HaltIfNull = 114;
    const int OP_OpenPseudo = 115;
    const int OP_OpenEphemeral = 116;
    const int OP_Null = 117;
    const int OP_Move = 118;
    const int OP_Blob = 119;
    const int OP_Add = 84   /* same as TK_PLUS     */;
    const int OP_Rewind = 120;
    const int OP_SeekGt = 121;
    const int OP_VBegin = 122;
    const int OP_VUpdate = 123;
    const int OP_IfZero = 124;
    const int OP_BitNot = 93   /* same as TK_BITNOT   */;
    const int OP_VCreate = 125;
    const int OP_Found = 126;
    const int OP_IfPos = 127;
    const int OP_NullRow = 128;
    const int OP_Jump = 129;
    const int OP_Permutation = 131;
    ...
    /* The following opcode values are never used */
    const int OP_NotUsed_132 = 133;
    const int OP_NotUsed_133 = 133;
